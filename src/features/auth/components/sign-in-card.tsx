      ...
      >
        <Card className="w-full max-w-[400px] shadow-2xl border-none bg-white">
          ...
          <CardFooter className="text-sm text-center text-muted-foreground flex flex-col gap-2">
            <Link href="/forgot-password" className="text-blue-600 underline hover:text-blue-700">
              Forgot your password?
            </Link>
            <div>
              Don&apos;t have an account?{" "}
              <Link href="/sign-up" className="text-blue-600 underline ml-1 hover:text-blue-700">
                Sign up
              </Link>
            </div>
          </CardFooter>
