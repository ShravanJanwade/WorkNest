...
export const StatusDropdown = ({ id, status, className, projectId }: StatusDropdownProps) => {
  ...
  const statusColorMap: Record<TaskStatus, string> = {
    ...
    [TaskStatus.IN_PROGRESS]:
      "bg-yellow-100 text-yellow-700 border-yellow-300 hover:bg-yellow-100/80",
          ...
          >
            <div
              className={cn(
                ...
                statusColorMap[s].split(" ")[0].replace("bg-", "bg-").replace("-100", "-500"),
              )}
            />
