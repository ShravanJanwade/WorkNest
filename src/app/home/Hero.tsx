...
const Hero = () => {
  return (
    ...
    {/* Layered gradients for luxury depth */}
      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-6">
        ...
        <nav className="flex items-center gap-5 text-white font-medium">
          <motion.div whileHover={{ scale: 1.1 }} transition={{ type: "spring", stiffness: 300 }}>
            <Link href="/sign-in">
              <Button variant="ghost" className="text-white hover:text-blue-300">Login</Button>
            </Link>
          </motion.div>
          <motion.div whileHover={{ scale: 1.1 }} transition={{ type: "spring", stiffness: 300 }}>
            <Link href="/sign-up">
    ...
    <div className="container relative z-30 mx-auto mt-32 flex h-full flex-col items-center justify-center px-6 text-center text-white">
      ...
      >
        Experience productivity like never before. AI, automation, collaboration – all in one sublime dashboard.
      </motion.p>
